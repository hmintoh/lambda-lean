<template>
  <main>
    ...
    <div class="main-wrapper">
      <BaseHoverCard id="live" class="section">
        <h2 slot="initialText" class="heading-h3">LIVE</h2>
        <div slot="detailText">
          <p>
      ...
      <BaseHoverCard id="fixed-installation" class="section">
        <h2 slot="initialText" class="heading-h3">
          FIXED INSTALLATION + CONSULTATION
        </h2>
        <div slot="detailText">
          <p>
      ...
      <BaseHoverCard id="broadcast" class="section">
        <h2 slot="initialText" class="heading-h3">BROADCAST + STUDIO</h2>
        <div slot="detailText">
          <p>
      ...
      <BaseHoverCard id="acoustic-design" class="section">
        <h2 slot="initialText" class="heading-h3">
        ...
        <div slot="detailText">
          <p>
            ...
            achieve optimal solutions for the acoustics in their given space.
          </p>
          <p>
